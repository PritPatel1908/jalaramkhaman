...
class RecurringOrderDetailsRelationManager extends RelationManager
{
    ...
    {
        return $table
            ->recordTitleAttribute('recurring_order_id')
            ->columns([
                Tables\Columns\TextColumn::make('recurring_order_id'),
            ])
            ->filters([
                //
            ])
